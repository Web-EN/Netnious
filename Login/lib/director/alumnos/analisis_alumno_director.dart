...
class _AlumnosState extends State<Alumnos> {
  ...
  Widget build(BuildContext context) {
    return MenuDirector(funcion: ContainerAlumnos());
  }
}

class ContainerAlumnos extends StatefulWidget {
  const ContainerAlumnos({super.key});

  @override
  State<ContainerAlumnos> createState() => _ContainerAlumnosState();
}

class _ContainerAlumnosState extends State<ContainerAlumnos> {
          ...
          children: <Widget>[
            ...
            Center(
              child: Container(
                ...
                margin: EdgeInsets.zero, // Ajusta el margen del contenedor aquí
