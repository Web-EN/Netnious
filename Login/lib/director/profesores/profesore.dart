...
class _ProfesoresState extends State<Profesores> {
  ...
  Widget build(BuildContext context) {
    return MenuDirector(funcion: ContainerProfesores());
  }
}

class ContainerProfesores extends StatefulWidget {
  const ContainerProfesores({super.key});

  @override
  State<ContainerProfesores> createState() => _ContainerProfesoresState();
}

class _ContainerProfesoresState extends State<ContainerProfesores> {
